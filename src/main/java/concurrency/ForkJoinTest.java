...
public class ForkJoinTest {
    public static void main(String[] args) {
        ...
        System.out.println("Use Fork Join:");
        Instant start = Instant.now();
        System.out.println(ForkJoinAdd.startForkJoinSum(num));
        Instant end = Instant.now();
        System.out.println("Elapse Time (in millis): " + Duration.between(start, end).toMillis());

        System.out.println("\nDo NOT Use Fork Join:");
        start = Instant.now();
